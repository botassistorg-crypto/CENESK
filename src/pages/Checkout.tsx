            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
              ...
              <section className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <div className="space-y-4">
                  <label className={`flex items-start gap-4 p-4 border rounded-lg cursor-pointer transition-colors ${selectedPaymentMethod === 'cod' ? 'border-[#B8965A] bg-[#B8965A]/5' : 'border-gray-200'}`}>
                    <input
                      type="radio"
                      value="cod"
                    ...
                    />
                    <div>
                      <span className="font-bold block text-[#1A1A1A]">Cash on Delivery (COD)</span>
                  ...
                  <label className={`flex items-start gap-4 p-4 border rounded-lg cursor-pointer transition-colors ${selectedPaymentMethod === 'bkash' ? 'border-[#B8965A] bg-[#B8965A]/5' : 'border-gray-200'}`}>
                    ...
                    <div className="w-full">
                      ...
                      {selectedPaymentMethod === 'bkash' && (
                        <input
                          {...register('transactionId', { required: selectedPaymentMethod === 'bkash' ? "Transaction ID is required" : false })}
